...
abstract class AndromedaAbstractNavBar @JvmOverloads constructor(
    ...
    abstract fun addFirstMenuBadge(badgeText: String)

    abstract fun hideFirstMenuBadge()

    abstract fun addSecondMenuBadge(badgeText: String)

    abstract fun hideSecondMenuBadge()
