...
import co.app.food.andromeda.ContextualActionListener
...
import co.app.food.andromeda.shadow.AndromedaShadowLayout
 ...
 * xml usage
 * ```xml
 * <co.app.food.andromeda.navbar.AndromedaNavBar
...
class AndromedaNavBar @JvmOverloads constructor(
    ...
    fun setContextualAction(
        ...
        findViewById<AndromedaButton>(R.id.navbar_contextual_action).apply {
            makeVisible()
            text = action
            setDebouncedClickListener { actionListener() }
        }
    }
    ...
    override fun addFirstMenuBadge(badgeText: String) {
        menuView.addFirstMenuBadge(badgeText)
    }

    override fun hideFirstMenuBadge() {
        menuView.hideFirstMenuBadge()
    }

    override fun addSecondMenuBadge(badgeText: String) {
        menuView.addSecondMenuBadge(badgeText)
    }

    override fun hideSecondMenuBadge() {
        menuView.hideSecondMenuBadge()
    }
     ...
     */
    override fun getMenuView1(): View? =
        menuView.view.findViewById<View?>(R.id.navigation_menu_icon_1)
     ...
     * If you are using a custom [AndromedaNavBarMenuView] implementation, don't use this method to get the menu view reference
     */
    override fun getMenuView2(): View? =
        menuView.view.findViewById<View?>(R.id.navigation_menu_icon_2)
