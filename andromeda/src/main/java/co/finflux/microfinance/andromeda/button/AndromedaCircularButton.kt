...
import co.app.food.andromeda.databinding.AndromedaCircularButtonBinding
...
import co.app.food.andromeda.tokens.fill_background_primary
import co.app.food.andromeda.tokens.fill_background_tertiary
...
class AndromedaCircularButton @JvmOverloads constructor(
    ...
    private val circularBtnInternal: AppCompatButton by lazy(LazyThreadSafetyMode.NONE) {
        binding.circularBtn
    }
        ...
        readAttributes(attrs, R.styleable.AndromedaCircularButton) { typedArray ->
            ...
            val loadingStateContentDescription =
                typedArray.getString(
                    R.styleable.AndromedaCircularButton_loading_state_content_description
                )
